...
public static class Metrics
{
    ...
    public static readonly Meter CreateBrokerageMeter = new Meter("OtPrCrBr.Example", "1.0.0");
    ...
    public static readonly Counter<long> CountBrokeragesCreated = CreateBrokerageMeter.CreateCounter<long>("brokerages.created.count", description: "Counts the number of brokerages created");
}